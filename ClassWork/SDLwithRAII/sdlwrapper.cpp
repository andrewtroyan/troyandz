...
SDLWindowWrapper::SDLWindowWrapper(const char *title, int x, int y, int w, int h, Uint32 flags): win_(nullptr)
{
...
SDLRendererWrapper::SDLRendererWrapper(SDL_Window *win, int index, Uint32 flags): ren_(nullptr)
{
